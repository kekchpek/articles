...
## Заключение
В целом, это основные вещи, которые надо бы знать, когда начинаешь писать C# код в Unity3d. Если у вас есть что добавить или указать на какие-то ошибки вы можете написать в комментарии к статье или завести issue в [GitHub]().